        ...
        <div :class="`${prefixCls}-content`" v-click-outside="handleClose">
          ...
          <ul :class="`${prefixCls}-list`" v-show="!getIsNotData" ref="scrollWrap">
            <li
              ...
              :title="item.info"
            >
              <UUIDDiv :uuid="item.uuid" :noClick="true" :uuidType="item.type as UUIDTypeEnum" />
              <div
                :class="`${prefixCls}-list__item-text`"
                style="
              ...
              >
                ...
                >
                  <template v-if="each.char != ' '">{{ each.char }}</template>
...
<script lang="ts" setup>
  ...
  const { handleSearch, searchResult, keyword, activeIndex, handleEnter, handleMouseenter } =
    useMenuSearch(refs, scrollWrap, emit, uuidModalConfig.value);
