...
<script lang="ts" setup>
  ...
  import { OverviewGetShutdownRank } from '@/api/equipmentManagement/equipmentOverviewTidy';
  ...
  const initChart = () => {
    ...
    const labelColor = ['#FD5360', '#e48530', '#FFAA00'];
    // 数据整理
  ...
  const queryChartData = () => {
    ...
    OverviewGetShutdownRank({}, urlParams)
      .then((res: any) => {
        res &&
          res.forEach((item) => {
